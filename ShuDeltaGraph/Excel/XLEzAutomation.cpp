...
CString CXLEzAutomation::GetCellValue(int nColumn, int nRow, VARTYPE iVarType )
{
	return m_pXLServer->GetCellValueCString(nColumn, nRow, iVarType );
}
...
long CXLEzAutomation::GetRowNum()
{
	return m_pXLServer->GetRowNum();
}