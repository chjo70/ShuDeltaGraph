...
public:
		...
		LPVOID GetParam( void ) const { return m_ThreadCtx.m_pUserData; };
		bool IsRunThread() { return m_ThreadCtx.m_hThread != NULL; }

		void Suspend() { WaitForSingleObject( m_ThreadCtx.m_hThread, INFINITE ); }
