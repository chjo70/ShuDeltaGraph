...
void CDlgFilterSetup::OnBnClickedOk()
{
	...
	m_stFilterSetup.dAoaMin = m_CSpinAoaMin.GetPos();
	m_stFilterSetup.dAoaMax = m_CSpinAoaMax.GetPos();
...
BOOL CDlgFilterSetup::OnInitDialog()
{
	...
	m_CSpinToaMin.SetPos ( m_stFilterSetup.dToaMin );
	...
	m_CSpinToaMax.SetPos ( m_stFilterSetup.dToaMax );
	...
	m_CSpinAoaMin.SetPos ( m_stFilterSetup.dAoaMin );
	...
	m_CSpinAoaMax.SetPos ( m_stFilterSetup.dAoaMax );
	...
	m_CSpinFrqMin.SetPos (m_stFilterSetup.dFrqMin);
	...
	m_CSpinFrqMax.SetPos (m_stFilterSetup.dFrqMax);
